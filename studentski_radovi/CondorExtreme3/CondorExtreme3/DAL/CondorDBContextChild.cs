...
namespace CondorExtreme3.DAL
{
    ...
    {
        public CondorDBContextChild() : base("cnCineStarTuzla") { }
        ...
        public DbSet<ModelsLocalDB.News> News { get; set; }
        public DbSet<ModelsLocalDB.Tag> Tags { get; set; }
        public DbSet<ModelsLocalDB.NewsTag> NewsTags { get; set; }
        public DbSet<ModelsLocalDB.Comment> Comments { get; set; }
        ...
        public DbSet<ModelsLocalDB.VirtualPointsPack> VirtualPointsPacks { get; set; }
        public DbSet<ModelsLocalDB.SalesOrderVirtualPoints> SalesOrderVirtualPoints { get; set; }

        public DbSet<ModelsLocalDB.Reservation> Reservations { get; set; }
        public DbSet<ModelsLocalDB.ReservationOnlineTransaction> ReservationOnlineTransactions { get; set; }
