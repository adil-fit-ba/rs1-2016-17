...
namespace CondorExtreme3.Areas.Local.Models
{
    public class RegisteredVisitorVM
    {
        ...
        //[Unique("Username already exists!", typeof(RegisteredVisitor))]
        ...
        //[Unique("Number already exists!", typeof(Visitor))]
        public string PhoneNumber { get; set; }
        
        [Required(ErrorMessage = "Email is required!")]
        [RegularExpression("^[^@]+@[^@]+\\.[^@]+$", ErrorMessage = "Invalid format!")]
        //[Unique("Email already exists!", typeof(RegisteredVisitor))]
